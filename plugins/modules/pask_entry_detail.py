...
class PaskEntryDetail(PaskModule):
    def __init__(self, name, module_args):
        super(PaskEntryDetail, self).__init__(name, module_args)
...
def main():
    entry_detail = PaskEntryDetail(name, module_args)
    entry_detail.set_param()
    entry_detail.run()
    entry_detail.set_result()
