...
param_list = [
    ...
    'fail_skip', 'priority', 'lb_method', 'vpnlb', 'position', 'multi_tunnel',
    'branch_relay'
]
...
class PaskFwlb(PaskModule):
    def __init__(self, name, module_args):
        super(PaskFwlb, self).__init__(name, module_args)
...
def main():
    fwlb = PaskFwlb(name, module_args)
    fwlb.set_param()
    fwlb.run()
    fwlb.set_result()
