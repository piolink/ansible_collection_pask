...
param_list = [
    ...
    'session_timeout_mode', 'fail_skip', 'priority', 'lb_method', 'flooding',
    'mirroring_mode'
]
...
class PaskIdslb(PaskModule):
    def __init__(self, name, module_args):
        super(PaskIdslb, self).__init__(name, module_args)
...
def main():
    idslb = PaskIdslb(name, module_args)
    idslb.set_param()
    idslb.run()
    idslb.set_result()
